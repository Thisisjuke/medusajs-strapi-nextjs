...
export const FilterProductForm = ({children, onSubmit, control, totalProducts = 0}) => {
      ...
      <Controller
        ...
        render={({ field }) => (
          <Select
            ...
            options={collectionsData?.collections?.map(collection => ({value: collection.id, label: collection.title}))}
            placeholder={formatMessage({
              id: getTrad('products-input-modal.collection-placeholder')
            })}
          />
        )}
      />
